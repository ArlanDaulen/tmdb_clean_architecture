...
class MovieDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context.read<MovieDetailsBloc>().add(LoadMovieDetails(movieId: movieId));
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: DefaultText(state.movie.overview ?? '(>_<)'),
              ),
              const SizedBox(height: 10),
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: DefaultText(state.movie.originalTitle),
                      ),
                      const SizedBox(height: 5),
                      const DefaultTitle(
                        'Status',
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 16),
                        child: DefaultText(state.movie.status),
                      ),
                      const SizedBox(height: 5),
                      const DefaultTitle(
                        'Original Language',
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 16),
                        child: DefaultText(state.movie.originalLanguage),
                      ),
                    ],
                  ),
                  const SizedBox(width: 10),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 16),
                          child: DefaultText('\$${state.movie.budget}'),
                        ),
                        const SizedBox(height: 5),
                        const DefaultTitle(
                          'Revenue',
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 16),
                          child: DefaultText('\$${state.movie.revenue}'),
                        ),
                      ],
                    ),
                  ),
      ...
      } else if (state is MovieDetailsLoadError) {
        return Center(
          child: DefaultText(
            state.message,
          ),
